<div class="entry title">
   <h2><a href="blog-single.php">Absolute beginner's guide to front-end web development</a></h2>
   
   <!-- Meta details -->
   <div class="meta">
      <i class="icon-calendar"></i> 3-2-2014 <i class="icon-user"></i> Admin <i class="icon-folder-open"></i> <a href="#">General</a> <span class="pull-right"><i class="icon-comment"></i> <a href="#">2 Comments</a></span>
   </div>
   
   <!-- Thumbnail -->
   <div class="bthumb">
      <a href="blog-single.php"><img src="img/front-end.png" alt="" class="img-responsive" /></a>
   </div>
